    ...
    <>
      <div id="projects" className="h-fit pt-36 flex flex-col md:flex-row">
        <section className="w-full project-section">
          <div>
            <h1 className="text-xl md:text-xl px-10 md:px-40 pb-5 border-b-2 text-purple-600">
              projects
            </h1>
            <h1 className="text-6xl md:text-8xl hover-effect px-10 md:px-40 border-b-2">
              calculator
            </h1>
            <h1 className="text-6xl md:text-8xl hover-effect px-10 md:px-40 border-b-2">
              crud
